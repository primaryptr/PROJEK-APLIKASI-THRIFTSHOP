...
<head>
    ...
    <style>
        ...
        * {
        ...
        .btn-tab:active {
            transform: translate(2px, 2px);
            box-shadow: 0px 0px 0 var(--charcoal);
        }
        .btn-tab.dark {
        ...
        /* ===== PRODUCT LIST ===== */
        .product-list {
            padding: 0 16px 80px; /* space for FAB */
            display: flex;
            flex-direction: column;
            gap: 14px;
        }
    ...
    <div class="android-device">
        ...
        <div class="screen-bezel">
            ...
            <div class="app-screen">
                ...
                <div class="stok-tabs">
                    <button class="btn-tab dark">Daftar Barang</button>
                </div>
                ...
                <div class="search-container">
                    <div class="search-box">
                        ...
                        <input type="text" placeholder="CARI BARANG / RAK..." />
                    </div>
                </div>

                <div class="filter-container">
                    <button class="filter-chip">SEMUA</button>
                    <button class="filter-chip">ATASAN</button>
                    <button class="filter-chip">BAWAHAN</button>
                    <button class="filter-chip">SEPATU</button>
                </div>
                ...
                <div class="product-list">
                    ...
                    <div class="product-card">
                        <div class="product-img"></div>
                        <div class="product-info">
                            <div class="product-title">90S NIKE WINDBREAKER</div>
                            <div class="product-meta">
                                <span class="product-price-stock">Rp.120.000 | STOK : 2</span>
                                <span class="product-id-badge">ID : 001</span>
                            </div>
                        </div>
                        <div class="product-actions">
