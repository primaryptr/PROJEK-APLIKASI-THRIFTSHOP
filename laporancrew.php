<?php
session_start();
if (empty($_SESSION['user_id']) || ($_SESSION['user_role'] ?? '') !== 'crew') {
...
<div class="phone">
    ...
    <div class="header">
        <div class="header-left">
            ...
            <div>
                ...
                <div class="header-role">CREW</div>
            </div>
        </div>
    ...
    <div class="content-inner">
        ...
        <div class="section-card">
            <div class="section-header">
                ...
                <span style="font-size:10px;font-weight:700;color:#475569;opacity:0.6;">Hanya Baca</span>
            </div>
            ...
            <div class="empty-state">
                ...
                <p>Belum ada transaksi.<br>
                   <a href="transaksicrew.php" style="color:#3B82F6;font-weight:700;">Buat transaksi baru →</a>
                </p>
            </div>
            <?php else: ?>
        ...
        <div class="section-card">
            <div class="section-header">
                ...
                <a href="stokcrew.php" class="section-link">Lihat Stok</a>
            </div>
    ...
    <div class="bottom-nav">
        ...
        <!-- Dashboard -->
        <a href="dashboardcrew.php" class="nav-item nav-inactive">
        ...
        <!-- Stok -->
        <a href="stokcrew.php" class="nav-item nav-inactive">
            <div class="nav-icon-wrap">
        ...
        <!-- User -->
        <a href="profilcrew.php" class="nav-item nav-inactive">
            <div class="nav-icon-wrap">
                <svg width="24" height="24" fill="none" stroke="#6B7280" stroke-width="2.5" viewBox="0 0 24 24">
        ...
        <!-- FAB: ke transaksi -->
        <div class="fab-wrap">
            <a href="transaksicrew.php" class="fab" title="Transaksi Baru">
