...
<body>
    ...
    <div class="android-device">
        ...
        <div class="screen-bezel">
            ...
            <div class="app-screen">
                ...
                <div class="search-container">
                    <div class="search-box">
                        ...
                        <input type="text" id="search-input" placeholder="CARI NAMA / KODE BARANG..." />
                    </div>
                </div>
            ...
            <div class="fab-container">
                <button class="btn-tambah-fab" onclick="window.location.href='tambahstokcrew.php'">+ Tambah</button>
            </div>
    ...
    <script>
        ...
        function renderProducts() {
            ...
            filtered.forEach(p => {
                const stockColor = p.stock === 0 ? 'var(--red)' : p.stock < 5 ? '#E9A03A' : 'var(--green)';
                const card = `
                    <div class="product-card">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-meta">
                                <span class="product-price-stock" id="stok-label-${p.db_id}" style="font-size: 11px; color:${stockColor};">STOK : ${p.stock}</span>
                                <span class="product-id-badge">${p.id}</span>
                            </div>
                        </div>
                        <div class="product-actions">
                            <a href="editstokcrew.php?id=${p.db_id}" style="display:inline-flex;">
