            ...
            <div class="bg-white border-2 border-gray-100 rounded-[2.5rem] p-7 relative overflow-hidden shadow-sm active:bg-gray-50 transition">
                ...
                <div class="absolute -right-4 -bottom-4 opacity-[0.05] rotate-12">
                    <svg width="120" height="120" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M21 8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16Z m-9-6.3L19.3 7 12 11.2 4.7 7Z m-1 18.2L4.3 16V8.2l6.7 3.8Z m2 0l6.7-3.8V8.2l-6.7 3.8Z" />
                    </svg>
                </div>
            </div>
