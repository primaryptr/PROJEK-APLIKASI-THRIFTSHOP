    ...
    if (!isset($_SESSION['user_id']) || !isset($_SESSION['user_role']) || $_SESSION['user_role'] != 'crew') {
            ...
            <div class="screen-bezel">
                ...
                <div class="app-screen">
                    ...
                    <div class="stats">
                        ...
                        <a href="stokcrew.php" class="stat-card dark" style="text-decoration:none;">
                    ...
                    <div class="stock-list">
                        <?php if ($jumlah_stok_kritis > 0): ?>
                            ...
                            ?>
                                <a href="stokcrew.php" class="stock-item" style="text-decoration:none;">
                ...
                <nav class="bottom-nav">
                    <a href="dashboardcrew.php" class="nav-item active">
