...
<body>
                        ...
                        <?php foreach($barang_list as $item): ?>
                            ...
                            <div class="katalog-card">
                                ...
                                <div class="katalog-body">
                                    ...
                                    <div class="katalog-harga"><?= $harga_brg ?></div>
                                    <button class="btn-copy" onclick="copyInfo('<?= addslashes($nama_brg) ?>', '<?= addslashes($harga_brg) ?>', '<?= addslashes($kat_brg) ?>')">Copy Info</button>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
    ...
    <script>
        function copyInfo(nama, harga, kategori) {
            const caption = 
`✨ ${nama} ✨
